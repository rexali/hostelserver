...
const getUserNotificationsHandler_1 = require("../handlers/getUserNotificationsHandler");
const notificationRouter = express_1.default.Router();
notificationRouter.get("/", getNotificationsHandler_1.getNotificationsHandler);
notificationRouter.get("/:id", getUserNotificationsHandler_1.getUserNotificationsHandler);
